    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="form-group">
                ...
                <label><h4><b>Total number of donors with <?= $donors[0]['b_type']; ?>:</b> </h4></label><span class="emphasize"><?= count($donors); ?> Donors</span>
...
<style>
    body{
        background-image: url("https://www.deccanherald.com/sites/dh/files/article_images/2020/05/19/file70kc18dlox411gg69752-1188005359-1560449918.jpg");
