...
<style>
    body{
        background-image: url("https://img.freepik.com/free-vector/happy-world-blood-donor-day-red-grey-yellow-background-social-media-design-banner-free-vector_1340-21612.jpg");
...
<div class="container">
    <div class="row">
        <div class="col-md-10">
            <!-- <h1 id="Heading">Why Are We Here For?</h1>
            <p id="About">
                Blood Bank System (BBS) is a browser based system that is designed to store, process, retrieve and analyze information concerned with the administrative and inventory management within a blood bank. This project aims at maintaining all the information pertaining to blood donors, different blood groups available in each blood bank and help them manage in a better way. Aim is to provide transparency in this field, make the process of obtaining blood from a blood bank hassle free and corruption free and make the system of b
            </p> 
            <hr id="line_1"> -->
            <!-- <h1 id="Heading2">Features</h1>
            <p>
...
- Camp Wise Donor List and Printing of Donor Cards.<br>
        ...
        <!-- </div>
        <div class="col-md-2">
        <img src="assets/bloodbank.png" class="img img-responsive">
