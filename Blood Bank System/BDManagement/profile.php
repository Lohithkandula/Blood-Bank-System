...
<style>
    body{
        background-image: url("https://patientengagementhit.com/images/site/article_headers/_large/medical-team-technology.jpg");
    }
</style>
<div class="container">
    <div class="row">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <table class="table table-condensed">
                        ...
                        <!-- <tr>
                            <td><label>Any Medical Conditions </label></td>
                            <td><?= $donor[0]['any_medical_conditions']; ?></td>
                        </tr> -->
                    </table>
                </div>
            </div>
