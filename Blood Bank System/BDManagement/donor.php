...
if(isset($_POST['submitBtn'])){
    ...
    /* $anymedicalconditions = $_POST['Anymedicalconditions']; */
    $hematocrit = $_POST['hematocrit'];

    require_once 'php/DBConnect.php';
    $db = new DBConnect();
    $flag = $db->addDonor($fname, $mname, $lname, $sex, $bType, $dob, $address, $city, $donationDate, $stats, $temp,
            $pulse, $bp, $weight, $hemoglobin, $hbsag, $aids, $malariaSmear /* $Anymedicalconditions */, $hematocrit, $mobile, $phone);
            ...
            <form method="post" class="form-horizontal" role="form" action="donor.php">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea rows="4" name="address" class="form-control" required="true"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <!-- <div class="form-group">
                            <label class="col-sm-4">Any Medical Conditions</label>
                            <div class="col-sm-8">
                                <input type="text" name="Anymedicalconditions" value="" required="true" class="form-control"/>
                            </div> -->
                        </div>
                        <div class="form-group">
...
<style>
    body{
        background-image: url("https://images.squarespace-cdn.com/content/v1/531f498ce4b04709d61c49b7/1474295070617-EH6AJ67L9JO2EXC7RN9U/header_1500x1000.jpg?format=1500w");
